...
export class EducadorListaInativosComponent implements OnInit {
  ...
  lista() {
    this.educadorService.listaInativos().subscribe(res => {
  ...
  ativar(id) {
    this.educadorService.ativar(id).subscribe(res => {
